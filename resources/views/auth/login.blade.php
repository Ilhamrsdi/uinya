                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="{{ URL::asset('assets/images/logo_poliwangi1.png') }}" alt=""
                                        height="72">
                                </div>
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Siakad POLIWANGI</h5>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Poliwangi. Crafted with <i class="mdi mdi-heart text-danger"></i>
                                by
                                Themesbrand
                            </p>
                        </div>
